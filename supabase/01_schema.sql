...
create table if not exists order_predictions (
  ...
  late_delivery_probability numeric(6, 5) not null,
...
create unique index if not exists ux_order_predictions_order_id
  on order_predictions(order_id);
...
create index if not exists idx_order_predictions_scored_at
  on order_predictions(scored_at desc);
